...
import 'package:mafia_project/ui/globalwidgets/animated_list.dart';

import '../../../../utils/paths.dart';
import '../../../theme/theme.dart';
import '../../../globalwidgets/open_all_button.dart';

class ListLeaders extends StatelessWidget {
  final bool visible;
  final int countItems;

  const ListLeaders({Key? key, required this.visible, required this.countItems})
      : super(key: key);
